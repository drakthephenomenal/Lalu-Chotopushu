...
var Jarvis = {
  ...
  send: function(msg) {
    ...
    var sp = 'You are Jarvis, the AI assistant for Radha Naam Jap — a spiritual practice app for devotees of Radha Rani.\n\n'
      ...
      +'You are READ-ONLY. You can only analyse and discuss the sadhana data. You CANNOT edit, modify, add or delete any data. If the user asks you to change any data, politely decline and say you are in analytics-only mode.\n\n'
