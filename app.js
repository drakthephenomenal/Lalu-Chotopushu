...
// ═══════════════════════════════════════════════════════════════════
// VAISHNAV OCCASIONS ENGINE
// Auto-calculates & adds all major Vaishnav/Vrindavan festivals
// for the current + next year using tithi (lunar calendar) rules.
// Uses panchangData.js astronomical functions (_tithiIdx, _elongation,
// _getSunriseHour, _sunMoonLongitudes) — no external API needed.
// ═══════════════════════════════════════════════════════════════════

// ── Festival definitions: each has a tithi (1-30), paksha, and Hindu month ──
// tithi: 1-15 Shukla, 16-30 Krishna (16=KP1...30=Amavasya)
// hindiMonth: 1=Chaitra 2=Vaishakha 3=Jyeshtha 4=Ashadha 5=Shravana
//             6=Bhadrapada 7=Ashwin 8=Kartik 9=Margashirsha 10=Pausha
//             11=Magha 12=Phalguna
// Special rule 'purnima' = tithi 15 Shukla, 'amavasya' = tithi 30 Krishna
// nakshatra: optional nakshatra name that must coincide (for Janmashtami etc.)
// weekday: optional 0=Sun..6=Sat constraint
// ────────────────────────────────────────────────────────────────────────────

const _VAISHNAV_FESTIVALS = [
  // ── Janmashtami (Krishna Ashtami) — Bhadrapada Krishna Ashtami ──
  { key:'janmashtami',  emoji:'🦚', name:'Janmashtami',         tithi:23, month:6,  approxMM:8  },
  // ── Radhashtami — Bhadrapada Shukla Ashtami ──
  { key:'radhashtami',  emoji:'🌸', name:'Radhashtami',          tithi:8,  month:6,  approxMM:9  },
  // ── Govardhan Puja — Kartik Shukla Pratipada ──
  { key:'govardhan',    emoji:'⛰️', name:'Govardhan Puja',       tithi:1,  month:8,  approxMM:10 },
  // ── Bhai Dooj (Yama Dwitiya) — Kartik Shukla Dwitiya ──
  // ── Diwali / Deepavali — Kartik Amavasya ──
  { key:'diwali',       emoji:'🪔', name:'Diwali',               tithi:30, month:7,  approxMM:10 },
  // ── Holi — Phalguna Purnima ──
  { key:'holi',         emoji:'🎨', name:'Holi (Holika Dahan)',  tithi:15, month:12, approxMM:3  },
  // ── Rang Panchami — Phalguna Krishna Panchami ──
  { key:'rangpanchami', emoji:'🌈', name:'Rang Panchami',        tithi:20, month:12, approxMM:3  },
  // ── Ram Navami — Chaitra Shukla Navami ──
  { key:'ramnavami',    emoji:'🏹', name:'Ram Navami',           tithi:9,  month:1,  approxMM:4  },
  // ── Hanuman Jayanti — Chaitra Purnima ──
  { key:'hanumanji',    emoji:'🙏', name:'Hanuman Jayanti',      tithi:15, month:1,  approxMM:4  },
  // ── Akshaya Tritiya — Vaishakha Shukla Tritiya ──
  { key:'akshayatritiya',emoji:'✨',name:'Akshaya Tritiya',      tithi:3,  month:2,  approxMM:5  },
  // ── Narasimha Chaturdashi — Vaishakha Shukla Chaturdashi ──
  { key:'narasimha',    emoji:'🦁', name:'Narasimha Chaturdashi',tithi:14, month:2,  approxMM:5  },
  // ── Nirjala Ekadashi — Jyeshtha Shukla Ekadashi ──
  { key:'nirjala',      emoji:'💧', name:'Nirjala Ekadashi',     tithi:11, month:3,  approxMM:6  },
  // ── Guru Purnima (Vyasa Purnima) — Ashadha Purnima ──
  { key:'gurupurnima',  emoji:'📿', name:'Guru Purnima',         tithi:15, month:4,  approxMM:7  },
  // ── Jhulan Yatra begin — Shravana Shukla Ekadashi ──
  { key:'jhulan_start', emoji:'🎪', name:'Jhulan Yatra Begins',  tithi:11, month:5,  approxMM:8  },
  // ── Jhulan Yatra end — Shravana Purnima ──
  { key:'jhulan_end',   emoji:'🎪', name:'Jhulan Yatra Ends',    tithi:15, month:5,  approxMM:8  },
  // ── Balaram Jayanti — Shravana Purnima ──
  { key:'balaram',      emoji:'🌾', name:'Balaram Jayanti',      tithi:15, month:5,  approxMM:8  },
  // ── Radha Kunda Snan — Kartik Krishna Ashtami ──
  { key:'radhakundasnan',emoji:'🌊',name:'Radha Kunda Snan',     tithi:23, month:8,  approxMM:10 },
  // ── Gopashtami — Kartik Shukla Ashtami ──
  { key:'gopashtami',   emoji:'🐄', name:'Gopashtami',           tithi:8,  month:8,  approxMM:11 },
  // ── Utthana Ekadashi (Dev Uthani) — Kartik Shukla Ekadashi ──
  { key:'devuthani',    emoji:'🪔', name:'Dev Uthani Ekadashi',  tithi:11, month:8,  approxMM:11 },
  // ── Tulsi Vivah — Kartik Shukla Dwadashi ──
  { key:'tulsiVivah',   emoji:'🌿', name:'Tulsi Vivah',          tithi:12, month:8,  approxMM:11 },
  // ── Kartik Purnima / Rasa Purnima ──
  { key:'kartikpurnima',emoji:'🌕', name:'Kartik Purnima · Rasa Lila',tithi:15,month:8,approxMM:11},
  // ── Gita Jayanti — Margashirsha Shukla Ekadashi ──
  { key:'gitajayanti',  emoji:'📖', name:'Gita Jayanti',         tithi:11, month:9,  approxMM:12 },
  // ── Vaikuntha Ekadashi — Margashirsha Shukla Ekadashi (same as Gita Jayanti) / alternate Pausha ──
  // ── Viveka / Saphala Ekadashi — Pausha Shukla Ekadashi ──
  { key:'paushaekadashi',emoji:'❄️',name:'Saphala Ekadashi',     tithi:26, month:9,  approxMM:12 },
  // ── Putrada Ekadashi — Pausha Shukla Ekadashi ──
  { key:'putrada',      emoji:'🌟', name:'Putrada Ekadashi',     tithi:11, month:10, approxMM:1  },
  // ── Makar Sankranti ── (solar, fixed ~Jan 14)
  { key:'makar',        emoji:'🌞', name:'Makar Sankranti',      solar: true, solarMM:1, solarDD:14 },
  // ── Vasant Panchami — Magha Shukla Panchami ──
  { key:'vasantpanchami',emoji:'🌼',name:'Vasant Panchami · Saraswati Puja',tithi:5,month:11,approxMM:2},
  // ── Maha Shivaratri — Magha / Phalguna Krishna Chaturdashi ──
  { key:'shivaratri',   emoji:'🔱', name:'Maha Shivaratri',      tithi:29, month:11, approxMM:3  },
  // ── Vrindavan-specific: Radhakund Utsav ──
  { key:'vrindavanMahotsav',emoji:'🏰',name:'Vrindavan Mahotsav',tithi:15, month:8,  approxMM:11 },
  // ── Nandotsav — Bhadrapada Krishna Navami ──
  { key:'nandotsav',    emoji:'🎊', name:'Nandotsav',            tithi:24, month:6,  approxMM:9  },
  // ── Annakuta / Govardhan Annakuta ──
  { key:'annakuta',     emoji:'🍛', name:'Annakuta',             tithi:1,  month:8,  approxMM:10 },
  // ── Radha Rasa Panchami — Kartik Shukla Panchami ──
  { key:'radharasa',    emoji:'💃', name:'Rasa Panchami',        tithi:5,  month:8,  approxMM:11 },
  // ── Gopastami ── (same as Gopashtami, deduplicated by key)
  // ── Braj 84 Kos Parikrama begin (approx Bhadrapada/Ashwin) — skip, too variable ──
  // ── Chaitra Navaratri begin — Chaitra Shukla Pratipada ──
  { key:'navaratriChaitra',emoji:'🌺',name:'Chaitra Navaratri Begins',tithi:1,month:1,approxMM:4},
  // ── Sharad Navaratri begin — Ashwin Shukla Pratipada ──
  { key:'navaratriSharad',emoji:'🌺',name:'Sharad Navaratri Begins',tithi:1,month:7,approxMM:10},
  // ── Vijaya Dashami / Dussehra — Ashwin Shukla Dashami ──
  { key:'dussehra',     emoji:'🏹', name:'Vijaya Dashami · Dussehra',tithi:10,month:7,approxMM:10},
  // ── Sharad Purnima / Kojagara Purnima — Ashwin Purnima ──
  { key:'sharadpurnima',emoji:'🌕', name:'Sharad Purnima · Kojagara',tithi:15,month:7,approxMM:10},
];

// Vrindavan-specific events (annual fixed-approximate or tithi-based)
const _VRINDAVAN_EVENTS = [
  // Braj Holi season: Lathmar Holi — Phalguna Shukla Navami (Nandgaon)
  { key:'lathmar_barsana', emoji:'🎨', name:'Lathmar Holi · Barsana',  tithi:9,  month:12, approxMM:3 },
  // Phalguna Shukla Dashami — Nandgaon Lathmar Holi
  { key:'lathmar_nandgaon',emoji:'🎨', name:'Lathmar Holi · Nandgaon', tithi:10, month:12, approxMM:3 },
  // Phalguna Shukla Ekadashi — Vrindavan Holi (Banke Bihari)
  { key:'vrindavan_holi',  emoji:'🌸', name:'Vrindavan Holi (Bihari Ji)',tithi:11,month:12, approxMM:3 },
  // Phalguna Shukla Purnima + 1 day — Braj Rang Mahotsav
  { key:'braj_rang',       emoji:'🌈', name:'Braj Rang Mahotsav',       tithi:15, month:12, approxMM:3 },
  // Kartik month Vrindavan Deepotsav — Kartik Purnima (same as kartikpurnima)
  // Radha Kunda Snan — already in main list
  // Govardhan Puja Vrindavan — already in main list
  // Yamuna Chhath — Bhadrapada Shukla Shashthi
  { key:'yamunachhath',    emoji:'🌊', name:'Yamuna Chhath · Vrindavan',tithi:6,  month:6,  approxMM:9 },
  // Banke Bihari Phool Bangla — Jyeshtha Shukla Ekadashi to Purnima
  { key:'phoolbangla',     emoji:'🌷', name:'Phool Bangla · Banke Bihari',tithi:11,month:3, approxMM:6 },
  // Vrindavan Parikrama — Kartik month, every day — just mark Kartik 1 and 30
  { key:'kartik_begin',    emoji:'🪔', name:'Kartik Month Begins · Vrindavan Parikrama',tithi:16,month:7,approxMM:10},
  // Sharad Purnima Raas Lila Vrindavan
  { key:'raas_sharad',     emoji:'💫', name:'Sharad Purnima Raas Lila · Vrindavan',tithi:15,month:7,approxMM:10},
  // Sawan Jhula (Jhulan) at Vrindavan temples — Shravana Shukla Dwadashi
  { key:'sawan_jhula',     emoji:'🎪', name:'Sawan Jhula · Vrindavan',   tithi:12, month:5,  approxMM:8 },
];

// ── Core: find the Gregorian date when a given tithi occurs near an approx date ──
// tithi 1-15 = Shukla 1-15, 16=KP1...29=KP14, 30=Amavasya
// We scan ±45 days around approxDate to find the sunrise-tithi match.
function _findTithiDate(tithiTarget, approxDate) {
  const DAY = 86400000;
  const start = new Date(approxDate.getTime() - 45 * DAY);
  for (let i = 0; i < 90; i++) {
    const d = new Date(start.getTime() + i * DAY);
    d.setHours(6, 0, 0, 0); // use 6am as proxy for sunrise
    const elong = _elongation(d);
    const tithiNow = Math.floor(elong / 12) + 1; // 1-30
    if (tithiNow === tithiTarget) {
      // Return clean midnight date
...
// ── Main: Auto-add all Vaishnav + Vrindavan occasions for a given year ──
function _autoAddVaishnavOccasionsForYear(year) {
  if (!App.S.occasions) App.S.occasions = {};
  const occ = App.S.occasions;
  let added = 0;
  const all = [..._VAISHNAV_FESTIVALS, ..._VRINDAVAN_EVENTS];

  all.forEach(fest => {
    // Solar festivals (fixed Gregorian)
    if (fest.solar) {
      const d = new Date(year, fest.solarMM - 1, fest.solarDD);
      const key = _fmtDateKey(d);
      if (!occ[key]) { occ[key] = fest.emoji + ' ' + fest.name; added++; }
      return;
    }

    // Tithi-based: build approx date from year + approxMM
    let mm = fest.approxMM;
    let yy = year;
    // Handle festivals that might be in Jan-Feb of next year
    const approx = new Date(yy, mm - 1, 10, 6, 0, 0);
    const found = _findTithiDate(fest.tithi, approx);
    if (found) {
      const key = _fmtDateKey(found);
      if (!occ[key]) { occ[key] = fest.emoji + ' ' + fest.name; added++; }
      else if (!occ[key].includes(fest.name)) {
        // Multiple festivals on same day — append
        occ[key] += ' · ' + fest.emoji + ' ' + fest.name;
      }
    }
  });
  return added;
...
// ── Public: called from UI button or auto on load ──
let _vaishnavFetching = false;
async function autoAddVaishnavOccasions() {
  if (_vaishnavFetching) return;
  _vaishnavFetching = true;
  const btn = document.getElementById('vaishnavOccBtn');
  const status = document.getElementById('vaishnavOccStatus');
  if (btn) { btn.disabled = true; btn.textContent = '⏳ Computing…'; }
  if (status) status.textContent = '🔢 Calculating tithi dates…';
  try {
    const today = new Date();
    const y1 = today.getFullYear();
    const y2 = y1 + 1;
    let added = _autoAddVaishnavOccasionsForYear(y1);
    added += _autoAddVaishnavOccasionsForYear(y2);
    App.save(); fbDebouncedPush();
    renderCal();
    if (status) status.textContent = `✅ ${added} occasions added for ${y1}–${y2}`;
    toast(`🪔 ${added} Vaishnav & Vrindavan occasions added! 🙏`);
  } catch(e) {
    if (status) status.textContent = '⚠️ ' + (e.message || 'Error');
    toast('Error: ' + (e.message || 'unknown'));
  } finally {
    _vaishnavFetching = false;
    if (btn) { btn.disabled = false; btn.textContent = '🪔 Auto-Add Vaishnav Occasions'; }
  }
}

// ── Auto-run silently on every app load (adds missing ones only) ──
function _silentAutoAddVaishnav() {
  try {
    const today = new Date();
    _autoAddVaishnavOccasionsForYear(today.getFullYear());
    _autoAddVaishnavOccasionsForYear(today.getFullYear() + 1);
    // No save here — will be saved with next regular save
  } catch(e) { /* silent fail */ }
}
