...
মিথ্যা জাপ: প্রতি মালা গড় ২ মিনিটের কম হলে সতর্ক করো।
...
function _aiShowUpdateConfirm(update) {
  ...
  div.innerHTML = `
    ...
    <div class="ai-update-btns">
      <button class="ai-confirm-btn" onclick='aiApplyUpdate(${JSON.stringify(update)},this)'>✅ প্রয়োগ করো</button>
...
function aiClearChat() {
  ...
  const chat = document.getElementById('aiChatBody');
  if (chat) {
    chat.innerHTML = `<div class="ai-welcome">
